...
![Construção da base do eletroímã.](imagens/base_eletroima.png){#id .class width=360 height=275px}
...
![Eletroímã montado.](imagens/eletroima.png){#id .class width=350 height=235px}
