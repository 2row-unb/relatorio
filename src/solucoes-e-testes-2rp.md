...
![Realização do teste com o alternador automotivo.](imagens/teste-com-alternador.jpg){width=290 height=235px}
...
![Ilustração conceitual de um freio eletromagnético [@medeiros80].](imagens/ilustracao-conceitual-do-freio.png){width=310 height=235px}
...
![Estrutura do freio eletromagnético.](imagens/eletroima_pic2.JPG){width=250 height=295px}
...
![Construção da base do eletroímã.](imagens/base_eletroima.png){width=550 height=230px}
...
![Enrolamento da bobina na base do eletroímã.](imagens/bobina.png){width=290 height=295px}
...
![Eletroímã montado.](imagens/eletroima.png){width=500 height=235px}
...
![Testes do eletroímã.](imagens/teste_eletroima.png){width=290 height=235px}
...
![Fonte de corrente constante do tipo colméia.](imagens/fonte-tipo-colmeia.jpg){width=290 height=235px}
...
![Disco de aço-carbono 1010.](imagens/disco.jpg){width=290 height=235px}
