...
![Construção da base do eletroímã.](imagens/base_eletroima.png){#id .class width=390 height=255px}
...
![Eletroímã montado.](imagens/eletroima.png){#id .class width=390 height=235px}
