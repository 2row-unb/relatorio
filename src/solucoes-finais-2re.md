...
Foi confeccionada uma placa responśavel pelas conexões da célula de carga e dos botões. A imagem abaixo apresenta a placa de conexão.

![Placa de conexão para a célula de carga](imagens/placa_2re.jpeg){width=290 height=295px}
